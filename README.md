...
- **Arc** (Circle's EVM L2, chainId `5042`) — native gas is **USDC** (18 decimals), so balances/prices report in USDC, not ETH. Default RPC `https://rpc.mainnet.arc.io` (override via `RPC_ARC`).
